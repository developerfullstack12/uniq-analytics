...
<section id="portfolio" class="tCenter ofsTop ofsBottom">
	...
	<div class="container clearfix">
		<h1 class="title tCenter"><?php printf( __( 'Category Archives Portfolio: %s', 'demeter' ), single_cat_title( '', false ) ); ?></h1>
	</div>
	<!--End container-->
		...
		<ul class="portfolio clearfix">
			...
			<li class="item">
				<div class="itemDesc">
					...
					<h3><?php the_title();?><span><?php printf( __( '%s', 'demeter' ), single_cat_title( '', false ) ); ?></span></h3>
