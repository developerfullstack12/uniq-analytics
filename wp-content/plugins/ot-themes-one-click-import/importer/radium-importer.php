    ...
    public function demo_installer() {
        ...
        <form method="post">
            ...
            <select name="ot_demo_file" style="width: 100px;">              												 
				<option value="dark">One-Page Dark</option> <!-- Davis change -->  
				<option value="light">One-Page Light</option> <!-- Davis change --> 
				<option value="photographer">Photographer</option> <!-- Davis change --> 
            </select>
            <br/><br/>
