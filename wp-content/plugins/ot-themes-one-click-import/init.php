<?php
 	...
 	* Description: One click import demo content - Demeter
 	* Version: 1.0
 	* Author: OceanThemes
...
class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
	...
	public function set_demo_menus() {
		...
		$homemenu = get_term_by('name', 'Home Menu', 'nav_menu');
		$main_menu = get_term_by('name', 'Page Menu', 'nav_menu'); // - Davis change				
		set_theme_mod( 'nav_menu_locations', array(
                'primary' => $main_menu->term_id, // - Davis change
				'secondary' => $homemenu->term_id, // - Davis change				                
            )
        );
	...
	public function set_demo_home(){
		$page = get_page_by_title( 'Home Page' ); // Edit home page name you want to set here. - Davis change
		if ( isset( $page->ID ) ) {
